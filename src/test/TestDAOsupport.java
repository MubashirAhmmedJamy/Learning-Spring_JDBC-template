...
public class TestDAOsupport {
    public static void main(String[] args) {
        ...
        EmployeeDAOsupport edao = context.getBean("empdaosup", EmployeeDAOsupport.class);
...
//      
        ...
        System.out.println("Inserting by named parameter from support");
